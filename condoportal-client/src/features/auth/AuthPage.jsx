...
function AuthPage({ modo = 'login' }) {
  ...
  return (
    <div className="acceso">
      {/* Frontend 1 monta el acceso como una tarjeta centrada de dos columnas
          —formulario y fotografía— en lugar de partir la pantalla entera. */}
      <section className="acceso__tarjeta">
        ...
        <main className="acceso__panel">
          ...
          <div className="acceso__formulario">
            <p className="eyebrow">CondoPortal</p>
            <h1 className="titulo">{esRegistro ? 'Crea tu cuenta' : 'Bienvenido de nuevo'}</h1>
            <p className="sub">
              {esRegistro
